...
/**
 * Espelha `packages/contracts/src/cart.test.ts` de propósito: este arquivo
 * reimplementa o schema/lógica de lá (ver comentário em `cart-storage.ts`),
 * então o comportamento tem que bater exatamente — mesmos casos, duas
 * fontes.
 */
