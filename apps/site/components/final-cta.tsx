    ...
    <section className="bg-cream px-6 py-16 text-center sm:px-10">
      <div className="mx-auto max-w-3xl">
        <h2 className="[font-family:var(--font-display)] text-display uppercase text-brand-strong">
          Sua comida já é boa. Falta o delivery ser seu.
        </h2>
        <p className="mt-4 text-body-lg text-text-muted">
          Cardápio digital, PIX e gestor de pedidos sem comissão. 7 dias grátis, sem cartão.
          Publica em menos de 30 minutos.
        </p>
